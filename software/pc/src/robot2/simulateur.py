...
class Simulateur:
    ...
    def __init__(self, config):
        ...
        client.service.addSensor(0,{"list":[{"int":[0,config["r2_epaisseur_avant"]]},{"int":[-600.,1600.]},{"int":[600,1600]}]})    # ultra son avant
        client.service.addSensor(1,{"list":[{"int":[0,config["r2_epaisseur_avant"]]},{"int":[-135.,1100.]},{"int":[135,1100]}]})    # infrarouge avant
