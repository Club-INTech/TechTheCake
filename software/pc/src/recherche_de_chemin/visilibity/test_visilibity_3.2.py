...
def testVisilibity():
    ...
    print('Walls in standard form : '+str(walls.is_in_standard_form()))
    ...
    print('Hole in standard form: '+str(hole.is_in_standard_form()))
    ...
    # Check if the hole is in standard form
    print('Hole in standard form: '+str(hole1.is_in_standard_form()))
