# Ce module de binding permet d'appeler des objets compilées dans la bibliothèque _visilibity.so
# This file was automatically generated by SWIG (http://www.swig.org).
#
# ...Et puis après je l'ai custom ;)
...
class Point(_object):
    ...
    def __eq__(self,other):
        dx = self.get_x()-other.x
        dy = self.get_y()-other.y
        return (dx**2 + dy**2) < Point.tolerance**2
