...
class Strategie:
    ...
    def __init__(self, robot, robotChrono, hookGenerator, rechercheChemin, table, timer, config, log): #retirer robot
        ...
        self.scripts = {"cadeaux1": ScriptCadeaux, "cadeaux2":ScriptCadeaux, "testHook":ScriptTestHooks} #"casser_tour":ScriptCasserTour
...
#            self.rechercheChemin.retirer_obstacles_dynamique();
            ...
            note={"cadeaux1":0, "cadeaux2":0, "verreNous":0, "verreEnnemi": 0, "gateau":0, "bougies":0, "deposer_verres":0, "pipeau1":0, "pipeau2":0, "pipeau3":0, "casser_tour":0, "testHook":0} #les clés sont les scripts
 ...
 #                   self.points["gateau"]+=2 #chaque bougie rapporte 4 points, mais la moitié des bougies sont à l'ennemi...
            ...
            for script in self.scripts:
                ...
                try:
                    ...
                    self.log.debug("self.points[script]="+str(self.points["cadeaux1"])+" dureeScript= "+str(dureeScript)+" distanceE "+str(distanceE))
