...
class Capteurs
{
	public:
        ...
        typedef CapteurSRF< timer_capteur_us, AVR_PORTC<PORTC1>, AVR_PORTC<PORTC2> > capteur_us1_type;
        capteur_us1_type us1;
        typedef CapteurSRF< timer_capteur_us, AVR_PORTC<PORTC3>, AVR_PORTC<PORTC4> > capteur_us2_type;
